...
LOGS.info(
    f"Jika {user.first_name} Membutuhkan Bantuan, Silahkan Tanyakan di Grup https://t.me/EskaySupport")
LOGS.info(
    f"🔥 𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧 🔥 ⚙️ V{BOT_VER} [TELAH DIAKTIFKAN!]")
    ...
    try:
        if BOTLOG_CHATID != 0:
            await bot.send_file(
                BOTLOG_CHATID,
                ALIVE_LOGO,
                caption=f"🔥 **𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧 Berhasil Diaktifkan**!!\n━━━━━━━━━━━━━━━\n➠ **Userbot Version** - 1.1 @𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧\n➠ **Ketik** `.ping` **Untuk Mengecheck Bot**\n━━━━━━━━━━━━━━━\n➠ **Powered By:** @EskaySupport ",
            )
    except Exception as e:
        LOGS.info(str(e))
    try:
