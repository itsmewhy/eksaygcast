...
# Support
GROUP = os.environ.get("GROUP", "EskaySupport")
CHANNEL = os.environ.get("CHANNEL", "EskaySupport")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧")
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/a92718eba5d1031c36aad.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/a92718eba5d1031c36aad.jpg"
)
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧 v{BOT_VER} is back up and running!**\n\n"
...
with bot:
    try:
        ...
        main_help_button = [
            ...
            [
                Button.url("📣 Updates", f"https://t.me/EskaySupport"),
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**🕹️ 𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧 Inline Menu 🕹️**\n\n🧸 **Owner :** [{user.first_name}](tg://user?id={user.id})\n🔮 **Jumlah :** `{len(dugmeler)}` **Modules**",
                await event.edit(
                    text,
                    file=ciliklogo,
                    buttons=buttons,
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@CilikUserbot"):
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository 𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧",
                    url="https://t.me/EskaySupport",
                    thumb=InputWebDocument(
                        ALIVE_LOGO,
                        0,
                        "image/jpeg",
                        []),
                    text="**𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧**\n➖➖➖➖➖➖➖➖➖➖\n✪ **Owner Repo :** [Eskay </>](https://t.me/EaskyTod)\n✪ **Support :** @EskaySupport\n✪ **Repository :** [𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧](https://github.com/WHYFZN/CilikUserbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
                                "https://t.me/EaskySupport"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/WHYFZN/CilikUserbot"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    title="✨ 𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧 ✨",
                    description="𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧 | Telethon",
                    url="https://t.me/eskaysupport",
                    thumb=InputWebDocument(
                        ALIVE_LOGO,
                        0,
                        "image/jpeg",
                        []),
                    text=f"**𝗘𝗦𝗞𝗔𝗬 𝗨𝗕𝗢𝗧**\n➖➖➖➖➖➖➖➖➖➖\n✪ **Owner :** [{user.first_name}](tg://user?id={user.id})\n✪ **Assistant:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**Updates:** @EskaySupport\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "Groups",
                                "https://t.me/EskaySupport"),
                            custom.Button.url(
                                "Repo",
                                "https://github.com/WHYFZN/CilikUserbot"),
                        ],
